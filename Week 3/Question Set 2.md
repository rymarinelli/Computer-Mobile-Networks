...
Tunneling is a communication protocol for that allows for the movement of data from network to another. It is a private connection. Putty is an example of an SSH tunnel.
 ```
